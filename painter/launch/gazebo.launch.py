...
def generate_launch_description():
    ...
    world = os.path.join(
        get_package_share_directory('painter'),
    ...
    robot_model = 'ur10'
    path_to_urdf = get_package_share_directory('painter') + '/urdf/'+ robot_model +'.urdf.xacro'
...
def generate_launch_description():
	...
	robot_model = 'ur10'
	xacro_file = get_package_share_directory('painter') + '/urdf/'+ robot_model +'.urdf.xacro'
	...
	spawn_entity_robot = Node(package     ='gazebo_ros', 
							  executable  ='spawn_entity.py', 
							  arguments   = ['-entity', 'painter', '-topic', 'robot_description'],
							  output      ='screen')

	# Gazebo   
	world_file_name = 'empty_world.world'
	world = os.path.join(get_package_share_directory('painter'), 'worlds', world_file_name)

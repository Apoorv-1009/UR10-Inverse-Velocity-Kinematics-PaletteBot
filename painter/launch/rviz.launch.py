...
def generate_launch_description():
	...
	# Launch RViz
	rviz_config_file = get_package_share_directory('painter') + "/rviz/rviz2.rviz"
	...
	rviz_config_dir = PathJoinSubstitution(
        [FindPackageShare("painter"), "rviz", "rviz2.rviz"]
    )
...
#     ####### DATA INPUT ##########
#     urdf_file = 'ur10.urdf'
#     xacro_file = "ur10.urdf.xacro"
#     package_description = "painter"
#     use_urdf = False
...
#         [FindPackageShare("painter"), "rviz", "display_default.rviz"]
#     )
